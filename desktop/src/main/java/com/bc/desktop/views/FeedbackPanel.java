...
public class FeedbackPanel extends JPanel {
    ...
    public void setAdminMode(boolean adminMode) {
        ...
        if (adminMode) {
            columnNames = new String[]{"ID", "Student #", "Rating", "Category", "Comments", "Date"};
        } else {
            columnNames = new String[]{"ID", "Rating", "Category", "Comments", "Date"};
        }
        ...
        if (adminMode) {
            ...
            feedbackTable.getColumnModel().getColumn(3).setPreferredWidth(120);
            feedbackTable.getColumnModel().getColumn(4).setPreferredWidth(200);
            feedbackTable.getColumnModel().getColumn(5).setPreferredWidth(100);
        } else {
            feedbackTable.getColumnModel().getColumn(0).setMaxWidth(50);
            feedbackTable.getColumnModel().getColumn(1).setPreferredWidth(80);
            feedbackTable.getColumnModel().getColumn(2).setPreferredWidth(120);
